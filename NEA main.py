...
#As the projectile represents a particle then it only experiences projectile motion without drag as drag is not experienced by particles/makes no noticeable difference
  ...
  def Motion(self,y,u,a):# Calculate projectile motion excluding drag, this is done by calculating the linear motion between thousands of small coordinates until a stopping condition is reached
    ...
    xlist = [] #######GROUP A - List - list of x coordinates for graph ########
    ylist = [] #######GROUP A - List - list of y coordinates for graph ########
